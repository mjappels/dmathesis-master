...
\cref{chap:crit-bh}\todoopt{need the right chapter reference}, setting $m=0$
removes the black hole horizon, and leaves pure AdS spacetime in Rindler-type
coordinates.  Performing the coordinate transformation~\cite{Podolsky:2002nk}:
\begin{align}
...
yielding the mass\todoopt{add definition with stress tensor}
\begin{align}
M= \int \rho _{\mathrm{E}} \ell^3 \sqrt{-\gamma^{(0)}}~dxd\phi
=\frac{\alpha m}{K}\,,
\end{align}
