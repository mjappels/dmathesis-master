...
non-zero cosmological constant, the boundary is actually rotating with angular
velocity
\begin{align}
...
\Omega_1 = \frac{aK}{\ell^2 \Xi}\left(1+\frac{\ell}{a}\zeta\right), \qquad V_1 =
...
=\frac{aK}{\ell^2
\Xi}\left[1+\frac{\ell}{a}\zeta\left(\frac{e^{2}}{l^{2}}\frac{1}{\Xi^{2}}\right)\right].
\end{gather}
