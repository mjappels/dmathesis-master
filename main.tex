...
\placehold{talk about unfinished work and correcting earlier work}

\todoruth[inline]{Need to prioritise the research
  material presentation. What is the narrative? Suggest: 1st step is deriving
  \emph{a} first law and defining thermo tension. How do we know what M is? Then
  turn to holographic work. Last bit the tedious solution stuff! Remember: Done
  is better than perfect!}

\section*{Conventions}
\addcontentsline{toc}{section}{Conventions}
Throughout this thesis we have used the mostly plus convention for metric
signatures. These metrics are expressed as the line element $ds^2 =
g_{ab}dx^adx^b$ in most cases. Unless stated otherwise, we are working in 3+1
