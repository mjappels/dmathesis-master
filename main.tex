...
\begin{acknowledgements*}
  ...
  and patient and willing to explain the many subtleties I had once failed to
  grasp. Within the Department of Mathematical Sciences at Durham, I would like
  to thank Aristos Donos for being my secondary supervisor and always being
  willing to have a quick chat. I would also like to thank Nigel Glover and
  Sebasti\' an Franco for being so encouraging during my years as an
  undergraduate. Finally, I would like to thank the administrative and support
  staff both from the department in Durham and at the Perimeter Institute in
  Canada.
  ...
  hosting me three times during my PhD.
...
\placehold{could include success stories about AdS/CFT}
...
that has led to this thesis, which revolves around merging these concepts and
...
unpublished. In this chapter we will focus on the construction of a first law
for the accelerating black hole and defining the physical quantities that enter
this framework.
...
of the equation.
\todoruth[inline]{Expand, eg $R_+ = m + \sqrt{m^2 - e^2}$, $m = \frac{r_+ +
    r_-}{2}$, maybe $\lambda = \frac{r_+ - r_-}{2}$ string between horizons. How
  does $\lambda$ look for uncharged AdS? straightforward to plot, maybe expand
  this part?}
...
\todoruth[inline]{still think this could be a distinct chapter with the
  rotational part included here. Very little work required.}
...
\todoruth[inline]{? Why not begin by fixing $\mu$ --- a la PRL?}
...
method described in \cite{Magnon:1985sc} \todoruth{ Is this true? Thought Komar
  did not work.}
\begin{equation}
...
coordinates $\{R,\Theta\}$, one takes \cite{Podolsky:2002nk}\todoruth{And these
  are? This section feels incomplete.}
\begin{equation}
