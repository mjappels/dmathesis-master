...
The authors of~\cite{Hawking:1998kw} didn't, however, discuss the first law of
...
first law. Instead, the authors of~\cite{Caldarelli:1999xj} propose treating the
cosmological constant $\Lambda$ itself as a thermodynamical variable, complete
with a conjugate quantity $\Theta = (\partial M/ \partial
\Lambda)_{S,J,Q}$, and we have the first law
\begin{align}
