...
Hawking, Hunter and Taylor-Robinson (HHT)~\cite{Hawking:1998kw} were the first to
...
is needed for regularisation, and find:
\begin{align}
...
\begin{align}
  ...
  \Omega = -\frac{g_{t\phi}}{g_{\phi\phi}}\Big|_{r_+} = \frac{a\Xi}{r_+^2+a^2},
\end{align}
...
velocity $\Omega + a/\ell^2$.

HHT didn't, however, discuss the first law of thermodynamics, and one can check
that \cref{eq:firstlaw} does not in fact hold with
\cref{eq:KerrAdSTS,eq:KerrAdSMJ-HTT,eq:KerrAdSO-HTT}. The following year,
