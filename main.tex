...
\placehold{introduction could be the story of motivation, how it had not been
  done before, and how one could posit thermo to begin with using physical
  intuition of holding tension fixed}

\placehold{in other words, could bring in first paper here}
...
\subsubsection{The critical non-rotating C-metric}
\label{sec:critnrC}
