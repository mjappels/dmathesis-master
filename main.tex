...
upon inspection of \cref{eq:fgNR} or, equivalently, requiring that there
be no roots of
...
\begin{figure}
  ...
  \caption{\label{fig:eA-m1p5a0p0}Parametric space for the non-rotating
    C-metric. The blue hatched region corresponds to solutions excluded by
    \cref{eq:conditionsNR}. The grey hatched region is excluded via cosmic
    censorship.}
\end{figure}
...
\begin{figure}
  ...
  \end{subfigure}\qquad
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{ae-m1p6A1p3-small}
    \caption{\label{fig:ae-m1p6A1p3}$m=1.6\ell$, $A=1.3\ell^{-1}$.}
  \end{subfigure}
