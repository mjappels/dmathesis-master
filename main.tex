...
\todoruth{You have an opportunity to expand here --- write down weyl ---
  explain conformal transformation, give calculation steps}The first argument
uses the Ashtekar--Das definition of conformal mass
...
$\omega$. The boundary metric is then given, in these coordinates, by:
